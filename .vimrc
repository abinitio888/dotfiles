...
let g:syntastic_yaml_checkers = ["mypy"]
...
"sqlx highlight
"git clone https://github.com/andres-lowrie/vim-sqlx.git ~/.vim/bundle/vim-sqlx


"lkml highlight
"git clone https://github.com/thalesmello/lkml.vim.git ~/.vim/bundle/lkml.vim
